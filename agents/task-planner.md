...
- Report task progress in a related file.md with clear status updates (e.g., "In Progress", "Blocked", "Completed")
- Update the progress file  whe a task is  completed.
**Key Principles**:
...
- Always align with best practices and project conventions
- Prefer simplicity and clarity over cleverness or optimization
