...
description: Revisiona il file correntemente aperto contro le best practices del progetto. Usalo quando l'utente dice "review", "review changes", "check this file", "revisiona", "controlla modifiche", o chiede di validare il lavoro corrente. Opera in PLAN MODE - propone miglioramenti, attende approvazione prima di eseguire.
...
Revisiona le modifiche del file corrente rispetto alle best practices del progetto. Opera in **plan mode**: propone, non esegue.
...
```bash
# Cercare best practices del progetto
