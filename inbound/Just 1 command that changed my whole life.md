---
title: "Just 1 command that changed my whole life"
source: "https://x.com/defileo/article/2055035402294046731"
author:
  - "[[Defileo🔮 (@defileo)]]"
published: 2026-05-14
created: 2026-05-29
description: "The /goal Command made me useless and that was the point.For two years I have been the bottleneck in every Claude Code session.Type a prompt..."
tags:
  - "clippings"
---
![Immagine](https://pbs.twimg.com/media/HITpVOhXcAEFfyx?format=jpg&name=large)
...
![Immagine](https://pbs.twimg.com/media/HITpqnAW8AA64qI?format=png&name=large)
...
<video preload="none" tabindex="-1" playsinline="" aria-label="Video incorporato" poster="https://pbs.twimg.com/amplify_video_thumb/2055033125818834945/img/QIbFGHmaIqm1R9UP.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/8bc0ff3a-fd8b-4af4-a5a2-90fbb48959a1"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2055033125818834945/img/QIbFGHmaIqm1R9UP.jpg?name=large)
...
The progress tracking line is the one most people skip and it matters more than they realize. Long runs drift. The model spends context on its own outputs, forgets earlier decisions, contradicts itself. A progress file gives Claude an external memory and gives you a way to check the run without interrupting it.

For multi-hour goals, also add plan.md and decisions.md. The plan file is the approach Claude commits to upfront. The decisions file is why specific choices were made. Together they keep long autonomous runs coherent and give you a paper trail when you come back.
...
/goal struggles with anything that requires real-time external verification. Tasks that need a human to look at a UI and react. Tasks where success is aesthetic rather than measurable. Tasks that depend on services Claude cannot test against.

It also struggles with goals that have hidden dependencies. If finishing the task requires data you have not given Claude access to, the loop will spin until it gives up or hallucinates a solution. The honest answer is to give Claude the access upfront or pick a different tool.
